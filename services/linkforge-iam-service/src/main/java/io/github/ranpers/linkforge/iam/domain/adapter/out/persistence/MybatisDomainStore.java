...
@Repository
public class MybatisDomainStore implements DomainStore {
    ...
    private final DomainStoreMapper mapper;

    public MybatisDomainStore(DomainStoreMapper mapper) {
        this.mapper = mapper;
    }
    ...
    @Override
    public UpdateResult update(UUID actorUserId, UUID domainId, String name) {
        Integer result = mapper.update(actorUserId, domainId, name);
